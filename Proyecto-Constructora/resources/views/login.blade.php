...
<section class="py-16 bg-white flex flex-col items-center text-center">
    <h2 class="text-3xl font-semibold mb-3">Login</h2>
    <form class="max-w-lg w-full grid gap-4 text-left">
        ...
        <button type="submit" class="bg-red-700 text-white px-6 py-2 rounded font-semibold hover:bg-red-800 transition">Login</button>
    </form>
</section>
@endsection
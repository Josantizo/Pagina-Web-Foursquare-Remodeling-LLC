...
<head>
    ...
    <!-- Favicons for different browsers and devices - Cross-browser compatibility -->
    <!-- Standard favicons - Fallback order matters -->
    <link rel="icon" type="image/jpeg" href="{{ asset('images/logo-foursquare.jpg') }}">
    <link rel="shortcut icon" type="image/jpeg" href="{{ asset('images/logo-foursquare.jpg') }}">
    <link rel="icon" type="image/jpeg" sizes="16x16" href="{{ asset('images/logo-foursquare.jpg') }}">
    <link rel="icon" type="image/jpeg" sizes="32x32" href="{{ asset('images/logo-foursquare.jpg') }}">
    <!-- High-resolution icons for modern browsers -->
    <link rel="icon" type="image/jpeg" sizes="192x192" href="{{ asset('images/logo-foursquare.jpg') }}">
    <link rel="icon" type="image/jpeg" sizes="512x512" href="{{ asset('images/logo-foursquare.jpg') }}">
    <!-- Apple Touch Icon for iOS devices -->
    <link rel="apple-touch-icon" href="{{ asset('images/logo-foursquare.jpg') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('images/logo-foursquare.jpg') }}">
    <!-- Windows Tiles -->
    <meta name="msapplication-TileImage" content="{{ asset('images/logo-foursquare.jpg') }}">
    <meta name="msapplication-TileColor" content="#f97316">
    <!-- Open Graph / Social Media -->
    <meta property="og:image" content="{{ asset('images/logo-foursquare.jpg') }}">
    ...
    <header class="sticky top-0 z-40 border-b border-orange-100/80 bg-white/95 backdrop-blur">
        <div class="container mx-auto flex items-center px-4 py-3 relative">
            <a href="/" class="flex items-center gap-3 flex-shrink-0">
                <img src="{{ asset('images/logo-foursquare.jpg') }}" 
                     alt="Foursquare Remodeling LLC logo" 
                     class="h-9 w-auto rounded border border-orange-100 shadow-sm object-contain"
                     loading="eager"
                     width="36"
                     height="36"
                     decoding="async">
            ...
            <div class="flex items-center gap-2 ml-auto">
                ...
                <a href="{{ config('social.instagram') }}" target="_blank" rel="noopener noreferrer" 
                   ...
                   <svg class="w-5 h-5" fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.281.07 1.665.07 4.849 0 3.185-.012 3.569-.07 4.849-.148 3.225-1.664 4.771-4.919 4.919-1.281.058-1.665.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.281-.07-1.665-.07-4.849 0-3.185.012-3.569.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.058 1.645-.07 4.849-.07zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                    </svg>
                </a>
                @endif
            </div>
